    ...
    this.modal = function(i, o) {
        ...
        i.find("body").append(h), e.prototype.pop = function(e) {
            ...
            return f.loading = !f.show && t.loadingMask, f.show = f.show || t.loadingMask, a.all({
                ...
                var r = angular.element(t.template.data).addClass("fg-modal");
                r = o(r)(e), n.$scope = e, i.controller && u(i.controller, t.locals), f.loading = !1, f.show = !0, h.append(r), n.$element = r, m.forEach(function(e) {
                    e.conceal()
