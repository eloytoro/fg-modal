angular.module("fgModal", ["ngAnimate"]).provider("Modal", function() {
    ...
    this.modal = function(i, o) {
    ...
    }, this.$get = ["$document", "$compile", "$rootScope", "$http", "$templateCache", "$q", "$animate", "$injector", "$controller", function(n, i, o, r, s, c, a, l, u) {
        ...
        i(angular.element('<div class="fg-modal-wrapper ng-hide" ng-show="show"></div>'))(d, function(e) {
            ...
            return this.templateUrl ? r({
                ...
                type: "text/html"
            }).success(l) : l(this.template), this.defaults && Object.keys(this.defaults).forEach(function(e) {
                a.defaults[e] instanceof Array ? a.defaults[e].forEach(function(n) {
                    t.on(e, n)
                }) : t.on(e, a.defaults[e])
            }), t
        };
